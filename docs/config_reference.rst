...
.. py:data:: SESSION_AEROSPIKE

      A ``aerospike.client`` instance.

      Default: Instance connected to ``'localhost:3000'``

.. py:data:: SESSION_AEROSPIKE_NAMESPACE

      The name of the namespace you want to use.

      Default: ``'flask_sessions'``

.. py:data:: SESSION_AEROSPIKE_BIND_KEY
